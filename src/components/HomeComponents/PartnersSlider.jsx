  ...
  switch (type) {
    case "aetheris":
      return (
        <svg className="w-full h-10 sm:h-12 max-h-full" viewBox="0 0 200 50" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="sliderAetherisGrad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#007aff" />
              <stop offset="100%" stopColor="#00c6ff" />
            </linearGradient>
          </defs>
          <path d="M25 38C32.1797 38 38 32.1797 38 25C38 17.8203 32.1797 12 25 12C17.8203 12 12 17.8203 12 25C12 32.1797 17.8203 38 25 38Z" stroke="url(#sliderAetherisGrad)" strokeWidth="3" strokeLinecap="round" />
          <path d="M38 25C38 32.1797 43.8203 38 51 38C58.1797 38 64 32.1797 64 25C64 17.8203 58.1797 12 51 12C43.8203 12 38 17.8203 38 25Z" stroke="url(#sliderAetherisGrad)" strokeWidth="3" strokeLinecap="round" strokeDasharray="3 3" />
    ...
    case "kortex":
      return (
        <svg className="w-full h-10 sm:h-12 max-h-full" viewBox="0 0 200 50" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="sliderKortexGrad" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <circle cx="31" cy="34" r="5" fill="url(#sliderKortexGrad)" />
    ...
    case "vortex":
      return (
        <svg className="w-full h-10 sm:h-12 max-h-full" viewBox="0 0 200 50" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="sliderVortexGrad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#3b82f6" />
              <stop offset="100%" stopColor="#1d4ed8" />
            </linearGradient>
          </defs>
          <path d="M15 15 L30 38 L45 15" stroke="url(#sliderVortexGrad)" strokeWidth="4.5" strokeLinecap="round" strokeLinejoin="round" />
    ...
    case "quantix":
      return (
        <svg className="w-full h-10 sm:h-12 max-h-full" viewBox="0 0 200 50" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="sliderQuantixGrad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#06b6d4" />
              <stop offset="100%" stopColor="#0891b2" />
            </linearGradient>
          </defs>
          <rect x="18" y="18" width="20" height="20" rx="4" stroke="url(#sliderQuantixGrad)" strokeWidth="3" transform="rotate(45 28 28)" />
    ...
    case "cyphr":
      return (
        <svg className="w-full h-10 sm:h-12 max-h-full" viewBox="0 0 200 50" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="sliderCyphrGrad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#10b981" />
              <stop offset="100%" stopColor="#059669" />
            </linearGradient>
          </defs>
          <path d="M15 20C15 15 30 10 30 10C30 10 45 15 45 20C45 30 30 40 30 40C30 40 15 30 15 20Z" fill="url(#sliderCyphrGrad)" fillOpacity="0.2" stroke="url(#sliderCyphrGrad)" strokeWidth="2.5" />
    ...
    case "optima":
      return (
        <svg className="w-full h-10 sm:h-12 max-h-full" viewBox="0 0 200 50" fill="none" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <linearGradient id="sliderOptimaGrad" x1="0%" y1="0%" x2="100%" y2="100%">
              <stop offset="0%" stopColor="#f43f5e" />
              <stop offset="100%" stopColor="#e11d48" />
            </linearGradient>
          </defs>
          <path d="M15 30 L23 16 L31 30 L39 16" stroke="url(#sliderOptimaGrad)" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.div className="flex-shrink-0 lg:w-2/5 text-center lg:text-left" variants={itemVariants}>
            <motion.h2
              className="text-black text-2xl sm:text-3xl lg:text-4xl font-black mb-4 uppercase tracking-tight"
            >
              Partners in <span className="bg-[#ffd13b] border-2 border-black px-2 shadow-[2px_2px_0_0_#000] inline-block rotate-[1deg] text-black">Success</span>
            </motion.h2>
            <motion.p
              className="text-black font-bold text-xs sm:text-sm leading-relaxed mb-6 max-w-md mx-auto lg:mx-0"
            >
            ...
            <Link to="/contact">
              <motion.button
                className="bg-[#ff4a77] text-black border-2 border-black px-5 py-2.5 font-black text-xs uppercase tracking-wider shadow-[3px_3px_0px_0px_#000] hover:shadow-[5px_5px_0px_0px_#000] hover:-translate-x-[2px] hover:-translate-y-[2px] active:translate-x-0 active:translate-y-0 active:shadow-[1px_1px_0px_0px_#000] transition-all duration-300 cursor-pointer"
            ...
            >
              {partners.map((partner) => (
                <SwiperSlide key={partner.id}>
                  <motion.div
                    className="bg-[#faf6ee] border-3 border-black p-4 h-28 sm:h-32 flex items-center justify-center shadow-[3px_3px_0_0_#000] hover:shadow-[5px_5px_0_0_#000] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all duration-300"
