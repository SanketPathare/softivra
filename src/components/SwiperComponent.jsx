...
import { ChevronLeft, ChevronRight, Clock, ArrowRight, Zap, Users, Rocket } from 'lucide-react';
  ...
  const slidesData = [
    {
      ...
      details: "Boost your online presence with our expert services and cutting-edge solutions.",
      image: "/public/slider_1.webp",
      icon: <Rocket className="w-16 h-16 text-blue-400" />,
      features: ["SEO Optimization", "Social Media Marketing", "Brand Development"]
    },
    {
      title: "Innovate Your Business",
      subtitle: "Technology & Solutions",
      details: "Transform your business with innovative technology and data-driven strategies.",
      image: "/public/slider_2.webp",
    ...
    },
    {
      ...
      details: "Create meaningful connections with compelling content and strategic engagement.",
      image: "/public/slider_3.webp",
      icon: <Users className="w-16 h-16 text-orange-400" />,
      features: ["Content Creation", "Community Building", "Analytics & Insights"]
    },
  ];
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-full h-1 bg-white/20 z-20">
        <div className="h-full bg-Maincolor"
