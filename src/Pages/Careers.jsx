    ...
    <div className="min-h-screen bg-[#faf6ee] pb-16">
      ...
      >
        <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-10 items-center">
          ...
          >
            <div className="p-6 border-3 border-black bg-[#ff4a77] shadow-[4px_4px_0_0_#000]">
              <img
                src="/career.svg"
          ...
          >
            ...
            >
              {[
                ...
                <motion.div
                  key={i}
                  className="bg-[#faf6ee] border-2 border-black p-5 shadow-[3px_3px_0px_0px_#000] hover:bg-white transition-all cursor-default"
                  variants={itemVariants}
                >
