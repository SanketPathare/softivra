    ...
    <div className="min-h-screen bg-slate-800">
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.p
            className="text-sm sm:text-base md:text-lg text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed"
            variants={itemVariants}
          >
          ...
          <motion.div
            className="flex flex-row sm:flex-row gap-3 sm:gap-4 justify-center"
            variants={containerVariants}
          >
            <motion.button
              className="bg-Maincolor hover:bg-blue-700 text-white font-semibold py-2 sm:py-3 px-6 sm:px-8 rounded-lg transition duration-300 transform hover:scale-105 text-sm sm:text-base"
              variants={itemVariants}
            ...
            <motion.button
              className="border-2 border-Maincolor text-Maincolor hover:bg-Maincolor hover:text-white font-semibold py-2 sm:py-3 px-6 sm:px-8 rounded-lg transition duration-300 text-sm sm:text-base"
              variants={itemVariants}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
      ...
      {/* CTA Section */}
      <motion.section
        className="bg-Maincolor py-12 px-4 sm:px-6 lg:px-8"
        variants={containerVariants}
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.3 }}
      >
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.p
            className="text-blue-100 text-base sm:text-lg mb-8 max-w-2xl mx-auto"
            variants={itemVariants}
          >
          ...
          >
            <motion.button
              className="bg-white text-Maincolor hover:bg-gray-100 font-semibold py-2 sm:py-3 px-6 sm:px-8 rounded-lg transition duration-300 text-sm sm:text-base"
              variants={itemVariants}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
            ...
            <motion.button
              className="border-2 border-white text-white hover:bg-white hover:text-Maincolor font-semibold py-2 sm:py-3 px-6 sm:px-8 rounded-lg transition duration-300 text-sm sm:text-base"
              variants={itemVariants}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
